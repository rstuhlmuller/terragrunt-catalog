...
variable "finalizers" {
  description = "Application finalizers"
  type        = list(string)
  default     = []
}

variable "spec" {
  description = "Complete Argo CD Application spec"
  type        = any
}

variable "extra_fields" {
  description = "Additional top-level manifest fields to merge into the Application"
  type        = map(any)
  default     = {}
}
